        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          >
            <div className="relative flex justify-center lg:justify-end">
              ...
              {/* Card flutuante — Avaliações Google */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.8 }}
                className="absolute -bottom-4 -left-4 lg:-left-8 bg-white/95 backdrop-blur-md rounded-2xl p-4 shadow-xl shadow-secondary-900/10 border border-white/80"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-semibold text-gray-800">5.0 no Google</p>
                    <p className="text-[10px] text-gray-400">Pacientes satisfeitas</p>
                  </div>
                </div>
              </motion.div>

              {/* Card flutuante — Especialidades (canto superior esquerdo) */}
              <motion.div
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 1.0 }}
                className="absolute top-8 -left-6 lg:-left-12 bg-white/95 backdrop-blur-md rounded-xl px-4 py-3 shadow-lg shadow-secondary-900/8 border border-white/80 hidden md:block"
              >
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-gold-100 flex items-center justify-center">
                    <Stethoscope className="w-4 h-4 text-gold-600" />
                  </div>
                  <div>
                    <p className="text-xs font-semibold text-gray-800">Microscopia na Hora</p>
                    <p className="text-[10px] text-gray-400">Resultado imediato</p>
                  </div>
                </div>
              </motion.div>
            </div>
