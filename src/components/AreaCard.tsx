...
export default function AreaCard({ iconName, title, description, delay = 0 }: AreaCardProps) {
  ...
  return (
    <AnimatedSection delay={delay}>
      <div className="card-elevated p-6 h-full group hover:border-secondary-300">
        <div className="w-14 h-14 bg-primary-50 rounded-2xl flex items-center justify-center mb-4 group-hover:bg-secondary-100 transition-colors">
