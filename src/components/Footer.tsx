...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-secondary-800 to-secondary-950 text-secondary-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-xs tracking-wider uppercase text-gold-400">Ginecologia e Obstetrícia</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {links.map((link) => (
                <li key={link.name}>
                  <Link href={link.href} className="text-secondary-300 hover:text-primary-200 transition-colors text-sm">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {areas.map((area) => (
                <li key={area}>
                  <Link href="/areas-de-atuacao" className="text-secondary-300 hover:text-primary-200 transition-colors text-sm">
                    {area}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="tel:+5518998207964" className="flex items-center gap-3 text-secondary-300 hover:text-primary-200 transition-colors text-sm">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-secondary-300 text-sm">Seg a Sex, 08:00 às 18:00</span>
              </li>
            </ul>
            ...
            <div className="mt-6 flex items-center gap-4">
              <a
                ...
                className="text-secondary-300 hover:text-gold-400 transition-colors"
      ...
      <div className="border-t border-secondary-800/50">
        <div className="container-custom py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/termos-de-uso" className="text-secondary-400 hover:text-primary-200 text-xs transition-colors">
              Termos de Uso
            </Link>
          </div>
